...
public class CentralizedParameter {
	...
	public static int dataType[]={10}; //25,50,75,90};
	 ...
	 * 
	 */	
	public static int noOfTimesRecommendationSegment=10;//,10,15,20,25,30,35,40,45,50};
	...
	public static String phase="Testing";
	...
	**/
	public static double costPerMetre=0.25; //{0.125,0.25,0.5,1.0,3.0,5.0,10.0};
	
	
	public static double ucb_ScalerMatrix=1.41421356237;
	...
	*/
	 ...
	 * Testing Cost value
	 */
	public static double[] testingCost = {0.125,0.25,0.5,1.0,3.0,5.0,10.0};
	...
	public static void main(String[] args) {
		...
		for(int y=0;y<dataType.length;y++)
		{
			...
			for(int m=0;m<distance.length;m++)
			{
				...
				for(int s=0;s<testingCost.length;s++)
				{
				...
				PrintStream UCTOutputFile=new PrintStream(new File("UCT/"+dataCategory+dataType[y]+"/"+distance[m]+"m"+"/C"+ucb_ScalerMatrix+"/cost"+costPerMetre+"/"+CentralizedParameter.testDataType+"/"+CentralizedParameter.noOfTimesRecommendationSegment+"/TestC"+testingUcb_scaler+"/TestCost"+testingCost[s]+"/Output.csv"));
				...
				System.out.println("Parameters used");
					...
					try {	
						...
						{
							phase="Training";
							uct.DemoUCT1.main(null,phase,TRAIN_INPUT_SEGMENT_FILE,TEST_INPUT_SEGMENT_FILE,UCTOutputFile,predictionSegments,pathOfLearntParameters,distance[m],noOfTimesRecommendationSegment,testingCost[s]);
						...
						if(experimentsType=="BASELINE")
						{
							...
							PrintStream BaseOutputFile=new PrintStream(new File("Baseline/"+dataCategory+dataType[y]+"/"+distance[m]+"m/"+testDataType+"/"+CentralizedParameter.noOfTimesRecommendationSegment+"/Output.csv"));
							TaxiRecommendation.Main.main(null,TRAIN_INPUT_SEGMENT_FILE,TEST_INPUT_SEGMENT_FILE,BaseOutputFile,writeTestCompleteData,predictionSegments,distance[m],noOfTimesRecommendationSegment);
						} 
